...
//          人物对自己产生护盾
            if (entry.getKey().equals(BuffConfig.DEFENSEBUFF)) {
                ...
                ProjectContext.userBuffEndTime.get(user).put(BuffConfig.DEFENSEBUFF, System.currentTimeMillis() + buff.getKeepTime() * 1000);
            }
//          人物集体治疗
...
//          集体解除控制
    ...
    public BigInteger defendBuff(BigInteger monsterDamage, User user, Channel channel) {
        if (ProjectContext.buffMap.containsKey(user.getBuffMap().get(BuffConfig.DEFENSEBUFF))) {
